...
Singleton {
    ...
    readonly property string bundledFamilyName:
        bundledFont.name || "Google Sans Flex"
    ...
    readonly property string ui: root.resolveFamily(
        root.configuredUi, root.defaultUi, "")
    readonly property string mono: root.resolveFamily(
        root.configuredMono, root.defaultMono, "monospace")
    readonly property string numeric: root.resolveFamily(
        root.configuredNumeric, root.defaultNumeric, "monospace")
    readonly property string expressive: root.resolveFamily(
        root.configuredExpressive,
        root.bundledFamilyName,
        root.ui
    )
    ...
    readonly property string materialSymbolsRounded:
        "Material Symbols Rounded"
    readonly property string materialSymbolsOutlined:
        "Material Symbols Outlined"
    readonly property string nerdFont: "JetBrainsMono Nerd Font"
    readonly property string nerdSymbols: "Symbols Nerd Font Mono"
    ...
    function cssFamily(family) {
        return "\""
            + String(family || "").replace(/\\/g, "\\\\").replace(/\"/g, "\\\"")
            + "\"";
    }
}
